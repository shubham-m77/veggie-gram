...
import feature_bg_1 from "./feature_bg_1.jpg";
import feature_bg_2 from "./farm_fresh.jpg";
import login_page_bg from "./login_page_bg.jpg"
import order_placed from "./order-placed.gif"
import address_bg from "./Address-bro.svg"
export const assets = {
  login_page_bg,
  search_icon,
  remove_icon,
...
export const features = [
  {
    ...
    title: "Same-Day & Early Morning Delivery.",
  },
  {
    icon: leaf_icon,
    title: "100% Freshness Guarantee with Farm to Home System.",
    
  },
  {
    icon: trust_icon,
    title: "Locally Sourced, Hand-Selected & Love by Indian Farmers.",
  },
];
...
export const dummyAddress = [
  {
    ...
    firstName: "Shyam",
    lastName: "Kumar",
    email: "user.shyamkumar@gmail.com",
    addressLine1: "Enclave Rd ETA 1",
